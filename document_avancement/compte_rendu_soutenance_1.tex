...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\large Un jeu d'aventure en pixel art avec voyage temporel\par}
    \vspace{3cm}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.8\textwidth]{exemple_code.png}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.5\textwidth]{logo_mobius.png}
%     \caption{Logo de Mobius - Représentation visuelle du voyage temporel}
% \end{figure}
