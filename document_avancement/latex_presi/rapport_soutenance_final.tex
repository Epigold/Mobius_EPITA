...
\begin{tabular}{@{}ll@{}}
  ...
  \textbf{Classes}          & 5 : Tank, Berserker, Vampire, Ninja, Mage \\[2pt]
...
\midrule
Georges Boyer       & Architecture (base\_room, main, mechanics, constants), IA ennemis, système d'armes, classes joueur, coffres, power-ups & \textcolor{okgreen}{\textbf{Terminé}} \\
\rowcolor{rowaltbg}
Madeleine Diop      & Graphismes (graphics.py), effets par époque, backgrounds, HUD, sprites & \textcolor{okgreen}{\textbf{Terminé}} \\
Emile Levast        & Lore des époques, textes in-game, site web M3G\_STUDIO & \textcolor{okgreen}{\textbf{Terminé}} \\
\rowcolor{rowaltbg}
Maël Bosse-Platière & Module réseau UDP (network.py), synchronisation client-serveur, gestion déconnexion & \textcolor{okgreen}{\textbf{Terminé}} \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{table}[H]
\centering
\caption{Inventaire complet des armes par époque}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{@{}lllccc@{}}
\toprule
\rowcolor{tableheadbg}
\textbf{Époque} & \textbf{Arme} & \textbf{Type} & \textbf{Dégâts} & \textbf{Cooldown} & \textbf{Stamina} \\
\midrule
\multirow{2}{*}{Préhistoire}   & Caillou        & Distanciel & 35  & 18 & 1 \\
                               & Os             & Mêlée      & 75  & 25 & 3 \\
\rowcolor{rowaltbg}
\multirow{2}{*}{Grèce Antique} & Arc            & Distanciel & 55  & 22 & 2 \\
\rowcolor{rowaltbg}
                               & Crâne          & Distanciel & 45  & 20 & 2 \\
\multirow{2}{*}{Période Edo}   & Katana         & Mêlée      & 95  & 20 & 4 \\
                               & Orbe Magique   & Distanciel & 70  & 30 & 5 \\
\rowcolor{rowaltbg}
\multirow{2}{*}{Ère Moderne}   & Carabine       & Distanciel & 80  & 20 & 2 \\
\rowcolor{rowaltbg}
                               & Couteau        & Mêlée      & 60  & 15 & 2 \\
\multirow{2}{*}{Guerre Mondiale} & AK-47        & Distanciel & 65  &  8 & 1 \\
                               & Grenade        & Distanciel AOE & 150 & 60 & 8 \\
\rowcolor{rowaltbg}
\multirow{2}{*}{Ère Futuriste} & Pistolet Laser & Distanciel & 90  & 12 & 2 \\
\rowcolor{rowaltbg}
                               & Minigun        & Distanciel & 50  &  4 & 1 \\
\bottomrule
\end{tabular}
\end{table}
...
\rowcolor{rowaltbg}
Ninja      & Vitesse $+15\%$, Dash CD$/2$       & Téléportation au curseur \\
Mage       & 150 Stamina, Regen $+50\%$          & Nova de projectiles \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Préhistoire      & Brun (139, 69, 19)      & Flammes animées (désactivées — code commenté) \\
\rowcolor{rowaltbg}
Grèce Antique    & Or grec (200, 180, 80)  & Soleil animé (désactivé — code commenté) \\
...
\begin{itemize}[leftmargin=1.8em, itemsep=2pt]
  ...
  \item[\okitem] Cinq classes de personnage (Tank, Berserker, Vampire, Ninja, Mage) avec compétences spéciales
  \item[\okitem] Système d'armes complet : 12 armes (distanciel, mêlée, AOE) réparties sur les 6 époques
...
\begin{itemize}[leftmargin=1.5em, itemsep=4pt]
  \item \textbf{Flammes préhistoriques et soleil grec} : ces effets ont été désactivés pour raisons de performance (méthode \texttt{draw\_epoch\_decoration} retournant \texttt{pass} dans \texttt{prehistoire.py} et \texttt{grece.py}). Le code reste commenté dans chaque fichier et est réactivable en une ligne.
...
\rowcolor{rowaltbg}
Effets décor toutes époques   & Oui   & \textcolor{warnorange}{\textbf{4/6 actifs (2 désactivés perf.)}} \\
Site web M3G\_STUDIO          & Oui   & \textcolor{okgreen}{\textbf{Oui}} \\
\rowcolor{rowaltbg}
Sprites animés ennemis (GIF)  & Bonus & \textcolor{okgreen}{\textbf{Préhistoire (tank, rusher, sniper)}} \\
